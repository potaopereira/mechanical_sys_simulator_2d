...
BallsOnSlopesSolver::get_d1c(p_t const & p, q_t const & q) const {
    ...
    out <<
        ...
        0, 0, 2*p03*q00*pow(radius1,-2)-2*p02*q01*pow(radius2,-2)-2*p05*slope*q00*pow(radius1,-2)+2*p04*slope*q01*pow(radius2,-2), 1, -slope, -p02*q01+p03*q00+slope*p04*q01-slope*p05*q00, 
