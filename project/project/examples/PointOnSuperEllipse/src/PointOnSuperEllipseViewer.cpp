...
PointOnSuperEllipseViewer::PointOnSuperEllipseViewer(
...
mSuperEllipse(new QGraphicsPathItem())
{
    ...
    QPolygonF myPolygon;
    int k = 200;
    double r = 1./getParam("outside_rinv");
    ...
    p0 << -1./getParam("outside_rinv"), 0, 1, 0, 0, 1;
    v0 << 0, 0, 0;

}

void
PointOnSuperEllipseViewer::reset(){
